...
/// <summary>
/// Sheet: UT14_UpdateUserStatus — <see cref="UpdateUserStatusCommandHandler.Handle"/>
...
/// </summary>
public class UT14_UpdateUserStatus_HandleTests
{
    private readonly Mock<IUnitOfWork> _uow = new();
    private readonly Mock<IUserRepository> _users = new();
    private readonly Guid _userId = Guid.NewGuid();

    public UT14_UpdateUserStatus_HandleTests()
    {
