...
/// <summary>
/// Sheet: UT20_PublishCourseHandler — <see cref="PublishCourseCommandHandler.Handle"/>
...
/// B3 cho thấy handler KHÔNG tự validate mà uỷ quyền hoàn toàn cho domain (xem UT19),
/// chỉ dịch exception thành mã lỗi nghiệp vụ.
/// </summary>
public class UT20_PublishCourse_HandleTests
{
    ...
    public UT20_PublishCourse_HandleTests()
    {
