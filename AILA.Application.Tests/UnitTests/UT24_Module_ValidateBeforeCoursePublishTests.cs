...
/// <summary>
/// Sheet: UT24_ValidateBeforePublish — <see cref="Module.ValidateBeforeCoursePublish"/>
/// Module: Course · CC = 2 · 3 test case
///
/// Nhánh: B1 = !_materials.Any() (throw)
/// Đây là hàng rào cuối được Course.Publish() gọi lan truyền cho từng học phần (xem UT19).
/// </summary>
public class UT24_Module_ValidateBeforeCoursePublishTests
{
