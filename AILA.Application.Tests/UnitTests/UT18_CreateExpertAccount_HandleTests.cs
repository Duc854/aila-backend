...
/// <summary>
/// Sheet: UT18_CreateExpertAccount — <see cref="CreateExpertAccountCommandHandler.Handle"/>
...
/// dùng ở luồng Reset Password (UT02) và ChangePassword (UT07). Bộ test khoá lại sự khác biệt này.
/// </summary>
public class UT18_CreateExpertAccount_HandleTests
{
    ...
    public UT18_CreateExpertAccount_HandleTests()
    {
