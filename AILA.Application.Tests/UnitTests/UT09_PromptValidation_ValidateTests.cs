...
/// <summary>
/// Sheet: UT09_ValidatePrompt — <see cref="PromptValidationService.ValidateAsync"/>
...
/// </summary>
public class UT09_PromptValidation_ValidateTests
{
    ...
    public UT09_PromptValidation_ValidateTests()
    {
